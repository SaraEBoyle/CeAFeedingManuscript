function [] = full_photometry_conflict_analysis()
    ...
    %signal_fibers = [1, 2];
    signal_fibers = [2];
    %Your control channel- if using isosbestic channel it will be the same
    ...
    for fold = 1:size(folders_to_analyze, 2)
        ...
        AnimalTrackingSaraV6('mov', event_groups, pre_times, post_times, baseline_times, control_fiber, signal_fibers, fiber_names, analyze_photometry_data, key_words)
