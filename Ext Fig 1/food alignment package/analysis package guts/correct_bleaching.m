function [gcamp, iso] = correct_bleaching(imported_data, file, correct_for_bleaching, gcamp, iso, moving_avg, frame_rate, trigger1, smoot)
    gcamp_clone = gcamp;
    ...
    for tray_time = tray_times
        after = find(times >= (tray_time - 60));
        before = find(times <= (tray_time));
