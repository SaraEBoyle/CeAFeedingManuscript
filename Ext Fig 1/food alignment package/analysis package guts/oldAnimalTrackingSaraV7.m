...
function [] = oldAnimalTrackingSaraV7(bleaching_correction, timing_data, imported_data, pre_times, post_times, baseline_times, control_fiber, signal_fibers, fiber_names, photometry_data)
%This is a list of all possible events to align to- do not change it
 signal_key_word = 'photom';
            ...
            if photometry_data == 1
                ...
                for signal = 1:2
                    ...
                    if signal == 1
                        ...
                        [gcamp, iso] = correct_bleaching_V3old(imported_data, workingdir, correct_for_bleaching, gcamp, iso, moving_avg, frame_rate, 1, 0);
