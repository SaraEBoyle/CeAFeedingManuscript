function [gcamp, iso] = correct_bleaching_V3old(imported_data, file, correct_for_bleaching, gcamp, iso, moving_avg, frame_rate, trigger1, smoot)
    gcamp_clone = gcamp;
    ...
    baseline_gcamp = [];
    baseline_iso = [];
    choco_times = imported_data{3, 1};
    times = gcamp(:, 1);
    for choco_time = choco_times'
        after = find(times >= (choco_time - 30));
        before = find(times <= (choco_time - 10));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if trigger1
        ...
        save(horzcat(file, 'Corrected_data_full_session.mat'), 'gcamp', 'iso');
        hold off
        green_cor = green;
        violet_cor = violet;
    elseif trigger1
