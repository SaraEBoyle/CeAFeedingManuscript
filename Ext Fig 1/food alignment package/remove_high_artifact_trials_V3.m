...
for o = 1:size(all_signal_paths, 2)
    ...
    %Skip stuff that isn't a data folder
    if contains(signal_path, 'Corrected_data')
        continue
    elseif contains(signal_path, 'Entire_Session')
        continue
    elseif contains(signal_path, 'session')
        continue    
    end
